...
causalegm <- function(x, y, v,
  ...
  params <- list(output_dir = output_dir,
                 ...
                 g_units = as.integer(g_units),
                 e_units = as.integer(e_units),
                 f_units = as.integer(f_units),
                 h_units = as.integer(h_units),
                 dv_units = as.integer(dv_units),
                 dz_units = as.integer(dz_units),
